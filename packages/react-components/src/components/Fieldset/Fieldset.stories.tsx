...
const meta: Meta<typeof Fieldset> = {
  ...
  argTypes: {
    ...
    describedBy: {
      control: 'text',
      description: 'Additional element IDs to append to the fieldset `aria-describedby` value.',
      table: {
        type: {
          summary: 'string',
        },
    ...
    children: {
      control: false,
      description: 'Inputs or other grouped content rendered inside the fieldset.',
    },
    className: {
      control: false,
...
export const AsPageHeading: Story = {
  ...
  render: (args) => (
    <Fieldset {...args}>
      <TextInput
        label={
          <>
            Building and street <span className="ofh-u-visually-hidden">line 1 of 2</span>
          </>
        }
      />
      <TextInput
        label={<span className="ofh-u-visually-hidden">Building and street line 2 of 2</span>}
      />
  ...
  parameters: {
    docs: {
      description: {
        story:
          'Use `isPageHeading` when the fieldset question is also the page heading. This mirrors the docs-site address example, including visually hidden text for the split address-line labels.',
      },
    },
  },
};
