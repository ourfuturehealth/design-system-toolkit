...
<div class="ofh-form-group">
  <fieldset class="ofh-fieldset" aria-describedby="dob-hint" role="group">
    ...
    <div class="ofh-hint" id="dob-hint">
    For example, 31 3 1980
    </div>
    <div class="ofh-date-input" id="dob">
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-day">
          Day
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2" id="dob-day" name="dob-day" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-month">
          Month
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2" id="dob-month" name="dob-month" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-year">
          Year
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-4" id="dob-year" name="dob-year" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
    </div>
  </fieldset>
...
```html
<div class="ofh-form-group">
  <fieldset class="ofh-fieldset" aria-describedby="dob-with-autocomplete-attribute-hint" role="group">
    <legend class="ofh-fieldset__legend">
      What is your date of birth?
    </legend>
    <div class="ofh-hint" id="dob-with-autocomplete-attribute-hint">
    For example, 31 3 1980
    </div>
    <div class="ofh-date-input" id="dob-with-autocomplete-attribute">
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-with-autocomplete-attribute-day">
          Day
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2" id="dob-with-autocomplete-attribute-day" name="dob-with-autocomplete-day" inputmode="numeric" type="text" autocomplete="bday-day" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-with-autocomplete-attribute-month">
          Month
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2" id="dob-with-autocomplete-attribute-month" name="dob-with-autocomplete-month" inputmode="numeric" type="text" autocomplete="bday-month" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-with-autocomplete-attribute-year">
          Year
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-4" id="dob-with-autocomplete-attribute-year" name="dob-with-autocomplete-year" inputmode="numeric" type="text" autocomplete="bday-year" pattern="[0-9]*">
        </div>
      </div>
    </div>
  </fieldset>
...
<div class="ofh-form-group ofh-form-group--error">
  <fieldset class="ofh-fieldset" aria-describedby="dob-errors-hint dob-errors-error" role="group">
    <legend class="ofh-fieldset__legend">
      What is your date of birth?
    </legend>
    <div class="ofh-hint" id="dob-errors-hint">
    For example, 31 3 1980
    </div>
    <span id="dob-errors-error" class="ofh-error-message">
    Error message goes here
    </span>
    <div class="ofh-date-input" id="dob-errors">
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-errors-day">
          Day
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2 ofh-input--error" id="dob-errors-day" name="day" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-errors-month">
          Month
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2 ofh-input--error" id="dob-errors-month" name="month" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-errors-year">
          Year
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-4 ofh-input--error" id="dob-errors-year" name="year" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
    </div>
  </fieldset>
...
{{ dateInput({
  ...
  "items": [
    {
      "name": "day",
      "classes": "ofh-input--width-2 ofh-input--error"
    },
    {
      "name": "month",
      "classes": "ofh-input--width-2 ofh-input--error"
    ...
    {
      "name": "year",
      "classes": "ofh-input--width-4 ofh-input--error"
    }
  ]
}) }}
```
...
```html
<div class="ofh-form-group ofh-form-group--error">
  <fieldset class="ofh-fieldset" aria-describedby="dob-day-error-hint dob-day-error-error" role="group">
    <legend class="ofh-fieldset__legend">
      What is your date of birth?
    </legend>
    <div class="ofh-hint" id="dob-day-error-hint">
    For example, 31 3 1980
    </div>
    <span id="dob-day-error-error" class="ofh-error-message">
    Error message goes here
    </span>
    <div class="ofh-date-input" id="dob-day-error">
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-day-error-day">
          Day
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2 ofh-input--error" id="dob-day-error-day" name="dob-day-error-day" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-day-error-month">
          Month
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-2" id="dob-day-error-month" name="dob-day-error-month" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
      <div class="ofh-date-input__item">
        <div class="ofh-form-group">
          <label class="ofh-label ofh-date-input__label" for="dob-day-error-year">
          Year
          </label>
          <input class="ofh-input ofh-date-input__input ofh-input--width-4" id="dob-day-error-year" name="dob-day-error-year" inputmode="numeric" type="text" pattern="[0-9]*">
        </div>
      </div>
    </div>
  </fieldset>
