...
[Preview the contents list component](https://ourfuturehealth.github.io/design-system-toolkit/components/contents-list/index.html)

### HTML markup

```html
<nav class="ofh-contents-list" role="navigation" aria-label="Pages in this guide">
  <h2 class="ofh-u-visually-hidden">Contents</h2>
  <ol class="ofh-contents-list__list">
    <li class="ofh-contents-list__item" aria-current="page">
      <span class="ofh-contents-list__current">What is AMD?</span>
    </li>
    <li class="ofh-contents-list__item">
      <a class="ofh-contents-list__link" href="https://www.nhs.uk/conditions/age-related-macular-degeneration-amd/symptoms/">Symptoms</a>
    </li>
    <li class="ofh-contents-list__item">
      <a class="ofh-contents-list__link" href="https://www.nhs.uk/conditions/age-related-macular-degeneration-amd/getting-diagnosed/">Getting diagnosed</a>
    </li>
    <li class="ofh-contents-list__item">
      <a class="ofh-contents-list__link" href="https://www.nhs.uk/conditions/age-related-macular-degeneration-amd/treatment/">Treatments</a>
    </li>
    <li class="ofh-contents-list__item">
      <a class="ofh-contents-list__link" href="https://www.nhs.uk/conditions/age-related-macular-degeneration-amd/living-with-amd/">Living with AMD</a>
    </li>
  </ol>
</nav>
```
