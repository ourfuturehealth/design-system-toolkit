...
```html
<div class="ofh-do-dont-list">
  <h3 class="ofh-do-dont-list__label">Do</h3>
  <ul class="ofh-list ofh-list--tick">
    <li>
      <svg class="ofh-icon ofh-icon__tick" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" aria-hidden="true" width="34" height="34">
...
<div class="ofh-do-dont-list">
  <h3 class="ofh-do-dont-list__label">Don't</h3>
  <ul class="ofh-list ofh-list--cross">
    <li>
      <svg class="ofh-icon ofh-icon__cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true" width="34" height="34">
