...
Find out more about the image component and when to use it in the [design system docs website](https://designsystem.ourfuturehealth.org.uk/design-system/components/image).

## Quick start example

[Preview the image component](https://ourfuturehealth.github.io/design-system-toolkit/components/image/index.html)

The canonical Nunjucks import path is `components/image/macro.njk`. The legacy `components/images/macro.njk` import remains available for backward compatibility.

### HTML markup

```html
<figure class="ofh-image">
  <img class="ofh-image__img" src="https://assets.nhs.uk/prod/images/S_1017_allergic-conjunctivitis_M15.2e16d0ba.fill-320x213.jpg" alt="Picture of allergic conjunctivitis" sizes="(min-width: 1020px) 320px, (min-width: 768px) 50vw, 100vw" srcset="https://assets.nhs.uk/prod/images/S_1017_allergic-conjunctivitis_M15.2e16d0ba.fill-640x427.jpg 640w, https://assets.nhs.uk/prod/images/S_1017_allergic-conjunctivitis_M15.2e16d0ba.fill-767x511.jpg 767w">
  <figcaption class="ofh-image__caption">
    Itchy, red, watering eyes
  </figcaption>
</figure>
<figure class="ofh-image">
  <img class="ofh-image__img" src="https://assets.nhs.uk/prod/images/S_1017_allergic-conjunctivitis_M15.2e16d0ba.fill-320x213.jpg" alt="Picture of allergic conjunctivitis">
</figure>
```
...
The image Nunjucks macro takes the following arguments:
