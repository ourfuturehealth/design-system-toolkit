...
Find out more about the link skip component and when to use it in the [design system docs website](https://designsystem.ourfuturehealth.org.uk/design-system/components/link-skip).
...
This can be fixed by either including the compiled JavaScript for all components `ofh-design-system-toolkit.min.js` or the individual component JavaScript `link-skip.js`.
...
[Preview the link skip component](https://ourfuturehealth.github.io/design-system-toolkit/components/link-skip/index.html)
...
The link skip Nunjucks macro takes the following arguments:
