...
3. **Add the SVG file**
   ...
   ```bash
   # Save to packages/toolkit/assets/icons/material/
   # Example: packages/toolkit/assets/icons/material/AppointmentBooking.svg
   ```

4. **Update the manifest**
   - Open `packages/toolkit/assets/icons/material/manifest.json`
